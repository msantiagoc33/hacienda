...
Route::get('/plantilla',             [ApartamentoController::class, 'plantilla'])->name('plantilla')->middleware(['auth']);
Route::get('/',                      [ApartamentoController::class, 'plantilla'])->name('plantilla')->middleware(['auth']);
